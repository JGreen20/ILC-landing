        ...
        <div id="pageslide-left" class="pageslide inner">
            <nav>
                <ul>
                    ...
                    <?php if ($this->user->has_permission('view_distritos')) : ?>
                    <li class="text-center <?php echo ($_active === 'districts') ? 'active': ''; ?>">
                        <a href="<?php echo base_url(); ?>admin/distritos/display" class="btn-dashboard"><?php echo $this->lang->line('cms_general_title_districts'); ?></a>
                    </li>
                    <?php endif; ?>

                    <?php if ($this->user->has_permission('view_comercios')) : ?>
                    <li class="text-center <?php echo ($_active === 'comercios') ? 'active': ''; ?>">
                        <a href="<?php echo base_url(); ?>admin/comercios/display" class="btn-dashboard"><?php echo $this->lang->line('cms_general_title_commerces'); ?></a>
                    </li>
                    <?php endif; ?>
